...
const SubMenuPanel = styled.div`
  ...
  background: ${({ theme }) => theme.colors.surface};
  border: 1px solid ${({ theme }) => theme.colors.onSurfaceVariant}20;
  border-radius: 12px;
  ...
  &::before {
    ...
    height: 12px;
    background: ${({ theme }) => theme.colors.surface};
    border-left: 1px solid ${({ theme }) => theme.colors.onSurfaceVariant}20;
    border-top: 1px solid ${({ theme }) => theme.colors.onSurfaceVariant}20;
  }
`
...
const SubLink = styled(Link)`
  ...
  &:hover {
    background: ${({ theme }) => theme.colors.surface};
    color: ${({ theme }) => theme.colors.primary};
    box-shadow: inset 0 0 0 1px ${({ theme }) => theme.colors.primary}30;
  }
`

/* Sticky shell que ahora envuelve Top + Bottom */
const HeaderShell = styled.header`
  position: sticky;
  top: 0;
  z-index: 950; /* por debajo de overlays (1000) y por encima del resto */
  box-shadow: ${({ $scrolled }) =>
...
const MobileSearchInput = styled.input`
  ...
  border-radius: 10px;
  border: 1px solid ${({ theme }) => theme.colors.onSurfaceVariant}33;
  outline: none;
  font-size: 0.95rem;
`
...
const OverlayTopBar = styled.div`
  ...
  justify-content: space-between;
  padding: ${({ theme }) => theme.spacing.md};
  border-bottom: 1px solid ${({ theme }) => theme.colors.onSurfaceVariant}22;
`
...
export default function Header() {
  ...
  return (
    <>
      {/* Sticky: ahora incluye Top + Bottom */}
      ...
      {/* Overlay móvil fuera del sticky */}
      {!isAuth && (
